...
var links = [
  ...
  {
    text: 'LinkedIn',
    href: 'https://www.linkedin.com/in/jacob-greenwald-developer/',
  },
]
    ...
    const menu = (
      <MobileModal>
        {links.map((link, index) =>
          ...
          ) : link.text === 'Resume' && this.state.location === '/resume/' ? (
            <Link key={index} to="/">
              Home
            </Link>
          ) : link.text === 'Projects' &&
    ...
    return (
      <React.Fragment>
        <MobileMenuContainer onClick={this.openMenu}>
          <span
            className={
              this.state.rotate && this.state.transition
                ? 'rotateUp transition'
                : this.state.rotate
                ? 'rotateUp'
                : 'transitionBack'
